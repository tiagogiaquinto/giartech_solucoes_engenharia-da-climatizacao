/*
  # Recriar função de detecção sem ambiguidade
  
  Drop e recreate com parâmetro renomeado
*/

-- Drop função anterior
DROP FUNCTION IF EXISTS thomaz_detect_mode_and_intent(text, uuid);

-- Recriar com nome de parâmetro sem ambiguidade
CREATE FUNCTION thomaz_detect_mode_and_intent(
  user_message text,
...
BEGIN
  ...
  -- Salvar contexto se tiver p_session_id
