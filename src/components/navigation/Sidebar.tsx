...
const DEFAULT_MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'dashboard-cfo', path: '/dashboard-cfo', icon: TrendingUp, label: 'Dashboard CFO', description: 'Inteligência Financeira Executiva' },
  { id: 'credit-scoring', path: '/credit-scoring', icon: Shield, label: 'Credit Scoring', description: 'Análise de crédito de clientes' },
  ...
  { id: 'relatorios-avancados', path: '/relatorios-avancados', icon: FileText, label: 'Relatórios Avançados', description: 'PDFs profissionais e análises' },
