  ...
  const loadData = async () => {
    try {
      ...
      const printData: OSPrintData = {
        ...
        instructions: order.instructions || order.orientacoes_servico || order.special_instructions || '',
        ...
        materials,
        team,
        labor_value: Number(order.labor_value || order.labor_total || order.valor_mao_de_obra || 0) || undefined,
        materials_value: Number(order.materials_value || order.materials_total_cost || order.valor_materiais || 0) || undefined,
        discount: discount > 0 ? discount : undefined,
        total_value: finalTotal,
        net_value: finalTotal,
        payment_method: order.payment_method || order.payment_methods || '',
        payment_installments: Number(order.payment_installments || 1),
        payment_conditions: order.payment_conditions || order.condicoes_pagamento || order.payment_terms || '',
        pix_key: order.pix_key || order.payment_pix || settings?.pix_key || '',
        warranty_period: Number(order.warranty_period || 90),
        ...
        company: settings ? {
          ...
          phone2: settings.phone2 || settings.whatsapp || '',
          email: settings.email,
          website: settings.website,
          logo_url: settings.logo_url,
          instagram: settings.instagram || '',
          slogan: settings.slogan || '',
          bank_name: settings.bank_name || order.payment_bank || '',
          bank_agency: settings.bank_agency || order.payment_agency || '',
          bank_account: settings.bank_account || order.payment_account || '',
          bank_account_type: settings.bank_account_type || order.payment_account_type || '',
          bank_holder: settings.bank_holder || order.payment_holder || '',
        } : undefined,
      }
