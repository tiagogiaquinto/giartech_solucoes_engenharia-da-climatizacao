...
import { Save, X, Eye, EyeOff, Download, Printer, FileText, Settings, Type, Bold, Italic, Underline, ChevronLeft as AlignLeft, AlignCenter as AlignCenter, Highlighter as AlignRight, AlignJustify as AlignJustify, List, ListOrdered, Image as ImageIcon, Table as TableIcon, Code, Link as LinkIcon, Maximize2, Minimize2, Undo, Redo, Trash2, Copy, ClipboardPaste, Sparkles, Palette, Columns as Columns, PanelRightOpen, PanelRightClose, Heading1, Heading2, Heading3, Quote, Minus, Plus, ZoomIn, ZoomOut } from 'lucide-react'
