  ...
  const prepareGiartechData = () => {
    ...
    return {
      ...
      client: {
        ...
        company_name: customer.nome_fantasia || undefined,
        cnpj: order.client_cnpj || customer.cnpj || undefined,
        cpf: order.client_cpf || customer.cpf || undefined,
        address: addressParts || order.client_address || undefined,
        city: customerAddr?.cidade || order.client_city || undefined,
        state: customerAddr?.estado || order.client_state || undefined,
        cep: customerAddr?.cep || undefined,
        email: order.client_email || customer.email || undefined,
        phone: order.client_phone || customer.telefone || customer.phone || undefined,
      },
      basic_info: order.service_date || order.scheduled_date ? {
        deadline: order.service_date || order.scheduled_date || order.due_date || '',
        brand: order.brand || undefined,
        model: order.model || undefined,
        equipment: order.equipment || undefined,
      } : undefined,
      ...
      total: finalTotal,
      payment: {
        methods: paymentMethodRaw || 'A Combinar',
        pix: pixKey || undefined,
